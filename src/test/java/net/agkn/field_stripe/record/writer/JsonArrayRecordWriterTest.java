...
/**
 * Unit tests for {@link JsonArrayRecordWriter} -- a {@link IRecordWriter} for
 * JSON-array based records.
 *
 * @author rgrzywinski
 * @see SmartJsonArrayRecordReaderTest
 */
public class JsonArrayRecordWriterTest {
    /**
    ...
    public void multipleRecordTest() throws Exception {
        ...
        { // locally scoped for sanity
            ...
            final IRecordWriter recordWriter = new JsonArrayRecordWriter(writer, false/*no pretty-print*/);
    ...
    public void flatTest() throws Exception {
        ...
        { // locally scoped for sanity
            ...
            final String expectedJson = "[1,2,3,4,5.01,6.01,true,\"string\"]";
            assertEquals(expectedJson, writer.toString());
        }
        ...
        { // locally scoped for sanity
            ...
            final String expectedJson = "[1,null,3,null,5.01,null,true,null]";
            assertEquals(expectedJson, writer.toString());
        }
    }
    ...
    public void arrayTest() throws Exception {
        ...
        { // locally scoped for sanity
            ...
            final String expectedJson = "[[111,112],[121,122],[131,132],[141,142],[15.01,15.02],[16.01,16.02],[true,false],[\"string181\",\"string182\"]]";
            assertEquals(expectedJson, writer.toString());
        }
        ...
        { // locally scoped for sanity
            ...
            // NOTE:  unset array fields are represented as "[]" rather than "null" 
            final String expectedJson = "[[],[],[[]]]";
            assertEquals(expectedJson, writer.toString());
        }        
    }
    ...
    public void structureTest() throws Exception {
        ...
        { // locally scoped for sanity
            ...
            final String expectedJson = "[[111,112,113,114,115.01,116.01,true,\"string118\"]]\n" +
                                        "[null]";
            assertEquals(expectedJson, writer.toString());
        }
    }
